<footer class="footer container mt-5 mb-3">
	<div class="d-sm-flex justify-content-center justify-content-sm-between">
		...
		<span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-muted">
			Hand-crafted, using <a href="https://getbootstrap.com/" class="bootstrap" rel="noreferrer noopener">Bootstrap</a>
		</span>
	</div>
</footer>